...
begin
  Stack^.push(new_d6v(crt.KeyPressed));
end;
...
begin
  Stack^.push(new_d6v(crt.WhereX32));
end;

procedure _WhereY32(Stack:PStack); cdecl;
begin
  Stack^.push(new_d6v(crt.WhereY32));
end;
