...
import _Application_LoadIconFromStream    "forms_api.lib"       "_Application_LoadIconFromStream"
...
import _Form_LoadIconFromStream           "forms_api.lib"       "_Form_LoadIconFromStream"
